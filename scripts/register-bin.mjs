 ...
 * Register a tiny shim so `pnpm exec joplin-brain …` matches acceptance commands.
 */
...
const shim = path.join(binDir, "joplin-brain");
...
const cliHealth = path.join(root, "bin", "joplin-brain-health-gui.js");
const shimHealth = path.join(binDir, "joplin-brain-health-gui");
